...
class HealthBar:
    def __init__(self, game):
        ...
        self.hearts = 4
        self.life = 8
        self.fullheart = pygame.image.load('Graphics\\fullheart.png').convert()
        self.halfheart = pygame.image.load('Graphics\\halfheart.png').convert()
        self.emptyheart = pygame.image.load('Graphics\\emptyheart.png').convert()
        self.heart_width = 32
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, *args):
        self.getInput()
        self.inventory.get_current_item().placeitem()
        self.healthbar.draw()
